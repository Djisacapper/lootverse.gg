...
const GAME_CARDS = [
  {
    ...
    page: 'Battles',
    size: 'large',
    gradient: 'from-[#00d9ff]/15 via-[#1a1a2e] to-[#0a0a15]',
    accent: '#00d9ff',
    emoji: '⚔️',
  ...
  },
  {
    ...
    page: 'Cases',
    size: 'large',
    gradient: 'from-[#ff006e]/15 via-[#1a1a2e] to-[#0a0a15]',
    accent: '#ff006e',
    emoji: '📦',
  ...
  },
  {
    ...
    page: 'Coinflip',
    size: 'small',
    gradient: 'from-[#9d4edd]/15 via-[#1a1a2e] to-[#0a0a15]',
    accent: '#9d4edd',
    emoji: '🪙',
  },
  {
    ...
    <div className="space-y-6">
      ...
      <div>
       <div className="flex items-center gap-2 mb-4">
         ...
         <h2 className="text-base font-bold text-[#00d9ff]">Magic Games</h2>
       </div>
